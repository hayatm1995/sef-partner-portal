...
function PagesContent() {
    ...
    // Authenticated users - show full app with all routes
    return (
        <AuthGuard>
            <Layout currentPageName={currentPage}>
                <Routes>
                    ...
                    {/* Partner Routes - accessible to partners and admins (admins can view as partner) */}
...
function SuperAdminPanelGuard() {
    ...
    // Check if user is superadmin (role === 'superadmin' or 'sef_admin')
    const isSuperAdmin = user?.role === 'superadmin' || user?.role === 'sef_admin';
