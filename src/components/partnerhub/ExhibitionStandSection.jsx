...
export default function ExhibitionStandSection({ partnerEmail, isAdmin }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-semibold">Exhibition Stand Brief</h3>
          <p className="text-sm text-gray-600">Describe your stand design and activation plans</p>
        </div>
      ...
      {(isEditing || !activation) ? (
        <Card className="border-orange-200">
          <CardHeader>
            <CardTitle>Exhibition Stand Details</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={6}
                  placeholder="Describe your stand concept, activities, and activation plans..."
                  required
                />
              </div>
              ...
              {(activation.booth_size || activation.power_requirements) && (
                <div className="grid md:grid-cols-2 gap-4 pt-3 border-t">
                  {activation.booth_size && (
                    <div>
                      <p className="text-sm font-medium text-gray-600">Stand Size</p>
      ...
      {!activation && !isEditing && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No exhibition stand details yet</h3>
            <p className="text-gray-600 mb-6">Create your exhibition stand brief</p>
            <Button onClick={() => setIsEditing(true)} variant="outline">
